...
\clearpage
  ...
  \begin{quote}
	  Contacto directo entre fase y neutro que provoca una sobrecarga en la linea y posibles incendios si la linea no esta protegida.
  \end{quote}
  ...
  \begin{quote}
	  Tanto los fusibles como los magnetotérmicos actúan como protección contra sobrecargas, la diferencia principal es que los magnetotérmicos son 
