...
\clearpage
  ...
  \begin{quote}
  % ✍️ Write your response here
	  Debemos de tener en cuenta la curva de actuación del magnetotérmicos 
  \end{quote}
...
\clearpage
  ...
  \item \boldit{Explica las dos formas de disparo de un interruptor magnetotérmicos  jd
